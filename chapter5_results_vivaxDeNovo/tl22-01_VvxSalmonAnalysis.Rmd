                       ...
                       expt_code <- expt_num.df$expt_code[match(expt, 
                         ...
                         assembly.list <- lapply(unique(samplesheet$assembly[samplesheet$Experiment == expt]),
                                                 function(assembly_file){
                                                   ...
                                                   quant_file <- paste(
                                                     "/camp/lab/langhornej/working/HPC/littlet/tl22-01_vivaxDeNovo/quantFiles_R",
                                                     expt, assembly, 
                                                     paste0('quant_', 
                                                            assembly,
...
buscos <- read.table('/camp/lab/langhornej/working/HPC/littlet/tl22-01_vivaxDeNovo/tl22-01_assembly_info_extra_busco.txt')
                 ...
                 function(subfampir.index){ 
                   ...
                   if(global_save_var){
                     ggsave(
                       ...
                       filename = paste0(
                         '/camp/lab/langhornej/working/HPC/littlet/tl22-01_vivaxDeNovo/plots/salmonQuant_plots/tl22-01_',
...
if(global_save_var){
  ggsave(
    plot = legend.plot,
    filename = '/camp/lab/langhornej/working/HPC/littlet/tl22-01_vivaxDeNovo/plots/salmonQuant_plots/tl22-01_legend_quantSalmon_stacked_subfam30pid25lngthI14.pdf',
    width = 7,
    height = 5,
    units = "in",
    dpi = 330
...
#           file = '/camp/lab/langhornej/working/HPC/littlet/tl22-01_vivaxDeNovo/github_project/tl22-01_vivaxDeNovo/expt_codes.csv',
#           row.names = FALSE)
...
if(global_save_var){
  ggsave(plot = plot,
         '/camp/lab/langhornej/working/HPC/littlet/tl22-01_vivaxDeNovo/plots/assemblies_numPirTranscripts_totalTranscripts.pdf',
         device = 'pdf',
         width = 7,
         height = 5,
         units = "in")
...
ISSUE: Why is the number of sequences in '/camp/lab/langhornej/working/HPC/littlet/tl22-01_vivaxDeNovo/hmmer/scspades/G18_B20_C19_Z16_M19_R20_K1719_G19-cat/G18_B20_C19_Z16_M19_R20_K1719_G19-cat_scspades_0.95cdhitest_hmmerPfam-PlasmodiumVir_200aa.fasta' larger than sum(assembly_info_samplesheet.df£$num_uniq_mRNA_pirHMMerORFs_nomatch95known_over200aa)
