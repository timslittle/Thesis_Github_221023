...
lapply(names(combined_data_pir_ht_list),
       function(list_name_to_order){
         ...
         clade_info <- combined_data_pir_ht
                  #Add a column for the SorL
         combined_data_pir_ht$SorL <- cir_info$SorL[match(rownames(combined_data_pir_ht), 
                                                                cir_info$Geneid)]
...
if(global_save_var){
  ggsave2(filename = 'Manuscript_SuppFigure3_chabaudi24h_pca_wPseudo.png',
          plot = plot,
          dpi = 300,
          width = 15,
          height = 10,
